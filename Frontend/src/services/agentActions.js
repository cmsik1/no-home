...
// The app shell passes live state and receives target pages/items plus user-facing guidance.
// DOM, map, and search side effects stay in the UI layer; this module remains unit-testable.
